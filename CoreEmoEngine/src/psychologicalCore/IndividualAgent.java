...
public class IndividualAgent {
	...
	private int simulation_id;   // used but not assigned a value
	...
	{
		IndividualAgent ia = new IndividualAgent();
		ia.agentPerception();
		
		ArrayList<String> trigEmos = ia.getTriggeredEmos();
